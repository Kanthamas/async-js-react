...
const App01Sync = () => {
	...
	const wait = (seconds) => {
		...
		// Simulating a long-running synchronous task --> Blocking UI
	...
	return (
		<div className="flex flex-col items-center h-full">
			...
			<h2 className="text-xl font-semibold text-amber-900">
				Blocking Cooking Process (Synchronous Process)
			</h2>
			<p className="mt-4 italic">{message}</p>
			<div className="flex gap-8">
				<button
					className="bg-emerald-300 text-emerald-950 px-8 py-2 my-4 rounded-xl shadow-md shadow-amber-950/50 hover:text-amber-300 hover:bg-amber-950"
